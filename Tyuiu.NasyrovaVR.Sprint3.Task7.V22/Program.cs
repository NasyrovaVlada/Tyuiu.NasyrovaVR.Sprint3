...
using Tyuiu.NasyrovaVR.Sprint3.Task7.V22.Lib;

namespace Tyuiu.NasyrovaVR.Sprint3.Task7.V22
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* F(x)=sin(x) + ------- - 1,5x   f(x) на заданном диапазоне [-5; 5]       *");
            Console.WriteLine("*                 2                                                       *");
